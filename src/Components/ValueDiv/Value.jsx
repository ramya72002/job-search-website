  ...
  return (
    <div className='mb-[4rem] mt-[6rem]'>
      ...
      <p className='text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
        Things begin made beautiful simple aare at the hear of everything we do.
      ...
      <div className='SingleGrid rounded-[10px] hover:bg-[#fcfae3] p-[1.5rem]'>
          <div className='flex items-center gap-3'>
            <div className='imgDiv p-[4px] rounded-[.8rem] bg-inherit-[#f3f2ad] h-[40px] w-[40px] flex items-center
        justify-center'>
        <img src={logo1} alt='' className='w-[70%]'/>
        </div>
